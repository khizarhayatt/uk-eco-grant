                    ...
                    <div class="<?php echo $isKanBan ? '' : 'panel-body' ; ?>">
                        ...
                        if ($isKanBan) { ?>
                            ...
                            //   ];
                              $_table_data[] = [
                               'name'     => "Address",
                               'th_attrs' => ['class' => 'toggleable', 'id' => 'th-address'],
                              ];
                              $_table_data[] = [
                            ...
                            //   ];
                              $_table_data[] = [
                               'name'     => _l('leads_dt_assigned_to'),
                               'th_attrs' => ['class' => 'toggleable', 'id' => 'th-assignees'],
                              ];
                              $_table_data[] = [
                              ...
                              $table_data = hooks()->apply_filters('leads_table_columns', $table_data);
                               ?>
                                    <div class="panel-table-full">
                                        <?php
                             //render_datatable($headings , $class , $additional_classes, $table_attributes )
                                 render_datatable(
                                   $table_data,
                                   'leads',
...
Swal.fire({
  ...
  if (result.isConfirmed) {
    $.ajax({
  url: `/admin/leads/delete/${id}`,
  type: 'GET',  // Specifies that this is a GET request
