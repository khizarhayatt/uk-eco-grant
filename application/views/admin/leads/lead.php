    ...
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="horizontal-scrollable-tabs preview-tabs-top panel-full-width-tabs mbot20">
                    ...
                    <div class="horizontal-tabs">
                        <ul class="nav-tabs-horizontal nav nav-tabs<?php if (!isset($lead)) {
                            ...
                            <!--    <a href="#tab_lead_overview" aria-controls="tab_lead_overview" role="tab"-->
                            <!--        data-toggle="tab">-->
                            <!--        <?php echo "PFF & AA"; ?>-->
                            <!--    </a>-->
                            <!--</li>-->
            ...
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane" id="tab_lead_overview">
                    <?php $this->load->view('admin/leads/overview'); ?>
                </div>
                <?php if (isset($lead)) { ?>
                <?php if (count($mail_activity) > 0 || isset($show_email_activity) && $show_email_activity) { ?>
