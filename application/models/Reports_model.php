...
class Reports_model extends App_Model
{
    ...
    public function report_by_customer_groups()
    {
       ...
       /**
     * Lead report by status / chart
     * @return arrray chart data
     */
    public function leads_sources_report_by_status($status_id)
    {
        $this->load->model('leads_model');
       
        $sources = $this->leads_model->get_source();
        $statuses = $this->leads_model->get_status($status_id);
        $chart   = [
            'labels'   => [],
            'datasets' => [
                [
                    ...
                    'borderColor'     => $statuses->borderColor,
                    'data'            => [],
                ],
            ],
        ];
