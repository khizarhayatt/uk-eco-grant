            ...
            <div class="modal-body">
                  ...
                  ?>
                      ...
                      $value = _d(date('Y-m-d'));
                        ...
                        ?>
                            ...
                            <!-- <div class="col-md-6"> -->
                                <?php
                                // $value = (isset($task) ? _d($task->duedate) : ''); 
                                 ?>
                                <?php
                                // echo render_date_input('duedate', 'task_add_edit_due_date', $value, $project_end_date_attrs);
                                  ?>
                            <!-- </div> -->
                            <div class="col-md-6">
                                <div class="form-group">
               ...
               ?>
                   ...
                   echo ' hide';
                        ...
                        <div class="checkbox checkbox-primary checkbox-inline task-add-edit-public tw-pt-2">
                            <input type="checkbox" id="task_is_appointment" name="is_appointment" <?php if (isset($task)) {
                               if ($task->is_appointment == 1) {
                                   echo 'checked';
                               }
                           }; ?>>
                            <label for="task_is_appointment" data-toggle="tooltip" data-placement="bottom"
                                title="<?php echo _l('task_appointment_help'); ?>"><?php echo _l('task_appointment'); ?></label>
                        </div>
                        <hr>
                        <div class="checkbox checkbox-primary checkbox-inline task-add-edit-public tw-pt-2">
                            <input type="checkbox" id="task_is_sms" name="notify_method[]" value="1"
                                <?php if (isset($task) && in_array(1, $task->notify_method)) { echo 'checked'; } ?>>
                            <label for="task_is_sms">SMS</label>
                        </div>
                        <div class="checkbox checkbox-primary checkbox-inline task-add-edit-public tw-pt-2">
                            <input type="checkbox" id="task_is_wa" name="notify_method[]" value="2"
                                <?php if (isset($task) && in_array(2, $task->notify_method)) { echo 'checked'; } ?>>
                            <label for="task_is_wa">WhatsApp</label>
                        </div>
                        <div class="checkbox checkbox-primary checkbox-inline task-add-edit-public tw-pt-2">
                            <input type="checkbox" id="task_is_mail" name="notify_method[]" value="3"
                                <?php if (isset($task) && in_array(3, $task->notify_method)) { echo 'checked'; } ?>>
                            <label for="task_is_mail">Email</label>
                        </div>
